...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "scheduler.settings.production")
...
NEWRELIC_CONFIG_FILE = os.path.join(PROJECT_DIR, "scheduler/newrelic.ini")
newrelic_env = os.environ.get("DJANGO_SETTINGS_MODULE")

if newrelic_env:
    # convert scheduler.settings.environment to environment
